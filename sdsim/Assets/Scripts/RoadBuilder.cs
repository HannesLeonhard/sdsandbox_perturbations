...
public class RoadBuilder : MonoBehaviour
{
	...
	public void InitRoad(CarPath path)
	{
		...
		// generate an int between 0 and roadTextures.Length
		int indexNewRoadTexture = Random.Range(0, roadTextures.Length);
		Texture2D selectedTexture = roadTextures[indexNewRoadTexture]; 
		mr.material.mainTexture = selectedTexture;
		Debug.Log("iRoadTexture: " + indexNewRoadTexture + " t: " + selectedTexture);
